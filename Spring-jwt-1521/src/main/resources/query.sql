...
INSERT INTO user (id, username, password, salary, age) VALUES (1, 'user1', '$2a$04$sXPjURdiPNtAB/phybelwOLVjPgp6f/UQYigaPmwVLx3clWEW83dq', 3456, 33);
INSERT INTO user (id, username, password, salary, age) VALUES (2, 'user2', '$2a$04$sXPjURdiPNtAB/phybelwOLVjPgp6f/UQYigaPmwVLx3clWEW83dq', 7823, 23);
INSERT INTO user (id, username, password, salary, age) VALUES (3, 'user3', '$2a$04$sXPjURdiPNtAB/phybelwOLVjPgp6f/UQYigaPmwVLx3clWEW83dq', 4234, 45);
